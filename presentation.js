(() => {
  ...
  const ideas = {
    friends: { number:'1-1', title:'나의 술친구 무무씨와 친구들', group:'explore', image:'./assets/flow/drink-id.png', target:'drink-friends', point:[0.94,0.54], fixedPoint:true, storyIndex:0 },
    ...
    'drink-id': { number:'1-4', title:'니술내술+', group:'explore', image:'./assets/flow/drink-id.png', target:'drink-id', point:[0.94,0.54], fixedPoint:true, storyIndex:1 },
    ...
    party: { number:'3-2', title:'파티+ 퀘스트 시작하기', group:'together', image:'./assets/party-quest/home.png', target:'party-quest', point:[0.94,0.54], fixedPoint:true, storyIndex:3 },
    'first-drink': { number:'4-1', title:'인생첫술 기프트 세트', group:'gift', image:'./assets/flow/first-drink.png', target:'first-drink', point:[0.94,0.54], fixedPoint:true, storyIndex:2 },
    cellar: {
  ...
  flowApp.addEventListener('load', () => {
    updateAppFrameScales();
    window.requestAnimationFrame(drawConnector);
    window.setTimeout(drawConnector, 180);
  });
